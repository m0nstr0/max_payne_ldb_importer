...
PLUGIN_NAME = "Max Payne SKD Import"
PLUGIN_COMPANY = "Bolotaev Sergey"
FILE_SKD_EXT = 'skd'

class MaxPayneSKDTranslator(OpenMayaMPx.MPxFileTranslator):
    def __init__(self):
...
def createMaxPayneKF2Translator():
    return OpenMayaMPx.asMPxPtr(MaxPayneSKDTranslator())
