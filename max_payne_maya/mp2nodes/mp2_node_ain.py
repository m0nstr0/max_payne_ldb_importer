...
class MP2NodeAin(OpenMayaUI.MPxLocatorNode):
    ...
    def initializeBaseAttributes():
        ...
        MP2NodeAin.HiddenAttr = hidden_attr.create("Hidden", "Hidden", OpenMaya.MFnNumericData.kBoolean, 0)
        ...
        MP2NodeAin.ExcludeFromGameAttr = exclude_from_game_attr.create("ExcludeFromGame", "ExcludeFromGame",
        ...
        MP2NodeAin.ExcludeFromLightingAttr = exclude_from_lighting_attr.create("ExcludeFromLighting",
                                                                                     "ExcludeFromLighting",
        ...
        MP2NodeAin.EnableExportRegroupingAttr = enable_export_regrouping_attr.create("EnableExportRegrouping",
