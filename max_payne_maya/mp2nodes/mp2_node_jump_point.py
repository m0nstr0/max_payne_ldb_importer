...
class MP2NodeJumpPoint(OpenMayaUI.MPxLocatorNode):
    ...
    def initializeBaseAttributes():
        ...
        MP2NodeJumpPoint.HiddenAttr = hidden_attr.create("Hidden", "Hidden", OpenMaya.MFnNumericData.kBoolean, 0)
        ...
        MP2NodeJumpPoint.ExcludeFromGameAttr = exclude_from_game_attr.create("ExcludeFromGame", "ExcludeFromGame",
        ...
        MP2NodeJumpPoint.ExcludeFromLightingAttr = exclude_from_lighting_attr.create("ExcludeFromLighting",
                                                                                     "ExcludeFromLighting",
        ...
        MP2NodeJumpPoint.EnableExportRegroupingAttr = enable_export_regrouping_attr.create("EnableExportRegrouping",
